...
cfg1 = CFG()
cfg1.add_prod('P', 'GN GV | GN GV CCM| CCT GN GV| GN GV PropSub | GN GV CCL| GN GV CCL')
cfg1.add_prod('S', 'P . P .')
...
cfg1.add_prod("CCL", "dans la vallée de dana | chez M.Titi | à la boulangerie de Paris | derrière le verre vert d'eau")
